...
class TestAccountPaymentPartner(common.SavepointCase):
    ...
    def test_in_invoice_onchange(self):
        ...
        self.assertEquals(invoice.payment_mode_id,
                          self.payment_mode_model)
        self.assertEquals(invoice.invoice_partner_bank_id,
    ...
    def test_invoice_refund(self):
        ...
        account_invoice_refund = self.env[
            'account.move.refund'].with_context(context).create(dict(
        ...
        self.assertEquals(invoice_refund.invoice_partner_bank_id,
                          self.env.ref(
    ...
    def test_partner_onchange(self):
        ...
        self.assertEqual(self.supplier_invoice.invoice_partner_bank_id,
                         self.supplier_bank)
